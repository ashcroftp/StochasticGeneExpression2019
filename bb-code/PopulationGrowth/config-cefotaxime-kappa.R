...
var.params <- data.frame(
    kappa = c(1e-6, 1.0, 2.0, 3.0),
    MIC.fraction = c(0.9332099, 0.9323611, 0.9311702, 0.9290991)
)
var.params <- lapply(10^seq(-1, 2, length.out = 31), function(drug) cbind(var.params, data.frame(drug.outsideConcentration.MULT = drug)))
